    ...
    const features = [
        {
            icon: "🔍",
            title: "Smart Search",
            description: "With FinSaver you can search for transactions by description, amount, date, category, and more."
        },
        {
            icon: "🏷️",
            title: "Auto-Categorization",
            description: "FinSaver automatically categorizes your transactions based on your spending patterns and your predefined categories."
        },
        {
            icon: "📊",
